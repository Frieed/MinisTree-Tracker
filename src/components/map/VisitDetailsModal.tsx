            ...
            {isOpen && visit && (
                <>
                    ...
                    <motion.div 
                        ...
                        className={`fixed bottom-0 left-0 right-0 ${visit.is_bible_study ? 'bg-[#F0F7F1]' : 'bg-[#FDFBF7]'} rounded-t-[3rem] min-h-[60vh] max-h-[90vh] overflow-y-auto z-[1100] shadow-2xl transition-colors duration-500`}
                    >
