        ...
        <AnimatePresence>
            {show && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[10000] flex items-center justify-center px-6 bg-nature-brown-dark/90 backdrop-blur-xl"
                >
                    <motion.div
                    ...
                    >
                        ...
                        <button
                            onClick={onClose}
                            className="w-full bg-nature-green hover:bg-nature-green-dark text-white rounded-[2rem] py-5 text-sm font-black uppercase tracking-[0.2em] shadow-xl shadow-nature-green/30 transition-all active:scale-95"
                        >
                            Continue Growing
                        </button>
                    </motion.div>
